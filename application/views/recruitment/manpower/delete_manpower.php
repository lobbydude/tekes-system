<script>
    $(document).ready(function () {
        $("#deletejobpost_Requisitions_form").submit(function (e) {
            ...
            $.ajax({
                url: "<?php echo site_url('Manpower/delete_jobpost') ?>",
                type: 'post',
                data: formdata,
                success: function (msg) {
                    if (msg == 'fail') {
                        ...
                        window.location.href = "<?php echo site_url('Manpower') ?>";
                    }
...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <input type="hidden" name="delete_jobpost_id" id="delete_jobpost_id" value="<?php echo $MP_Id; ?>">
    </div>
</div>
