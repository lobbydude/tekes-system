<script>
    $(document).ready(function () {
        $('#addleavecarryforward_form').submit(function (e) {
            e.preventDefault();
            var formdata = {
                start_month_list: $('#start_month_list').val(),
                start_year_list: $('#start_year_list').val(),
                end_month_list: $('#end_month_list').val(),
                    ...
                    <table class="table table-bordered datatable" id="leavecarryforward_table">
                        ...
                        <tbody>
                            ...
                            foreach ($q->Result() as $row) {
                                $L_Id = $row->L_Id;
                                $Start_Month1 = $row->Start_Month;
                                $Start_Month = date("F", mktime(0, 0, 0, $Start_Month1, 10));
                                $Start_Year = $row->Start_Year;
                                $End_Month1 = $row->End_Month;
                                $End_Month = date("F", mktime(0, 0, 0, $End_Month1, 10));
                                $End_Year = $row->End_Year;
                                ?>
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $Start_Month . " " . $Start_Year; ?></td>
                                    <td><?php echo $End_Month . " " . $End_Year; ?></td>
                                    <td>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="field-1" class="control-label">Period Start</label>
                                        <select class="round" id="start_month_list" name="start_month_list">
                                            <?php
                                            for ($m = 1; $m <= 12; $m++) {
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="start_year_list" name="start_year_list" class="round">
                                            <?php
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="round" id="end_month_list" name="end_month_list">
                                            <?php
                                            for ($m = 1; $m <= 12; $m++) {
                                                $current_month = date('m');
                                                $month = date('F', mktime(0, 0, 0, $m, 1, date('Y')));
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="field-1" class="control-label"></label>
                                        <select id="end_year_list" name="end_year_list" class="round">
                                            <?php
                                            for ($count = $current_year; $count >= DOB_YEAR_START; $count--) {
                                                ?>
                                                <option value="<?php echo $count; ?>"><?php echo $count; ?></option>
