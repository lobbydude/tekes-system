...
$get_compoff = array(
    'Compoff_Year' => $selected_year,
    'Status' => 1
);
$this->db->where($get_compoff);
                            ...
                            <form action="" name="compoff_search" id="compoff_search">
                                ...
                                <select id="holiday_year" name="holiday_year" onchange="location = this.options[this.selectedIndex].value;" class="round">
                                    ...
                                    for ($count = $current_year; $count >= DOB_YEAR_START; $count--) {
                                        ?>
                                        <option value="<?php echo site_url('Leaves/Leavecompoff/' . $count); ?>" <?php if($selected_year == $count){echo 'selected="selected"';}?>><?php echo $count; ?></option>;
                                        <?php
                                    }
                                    ?>
                                </select>
