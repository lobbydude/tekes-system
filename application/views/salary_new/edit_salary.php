...
foreach ($q_salary->result() as $row_salary) {
    ...
    $edit_additional_insurance = $row_salary->Additional_Insurance;
}
?>
<script>
    $(document).ready(function () {
        $('#editsalary_form').submit(function (e) {
            ...
            var formdata = {                
                ...
                edit_additional_insurance: $('#edit_additional_insurance').val(),
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" name="edit_additional_insurance" id="edit_additional_insurance" class="form-control" value="<?php echo $edit_additional_insurance; ?>">
                </div>
            </div>
        </div>
        <div class="col-md-3">
