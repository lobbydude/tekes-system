...
// Additional Insurance start IF(S3>0,0, IF(BK3>0,200+BK3,200))
/*$additional_insurance = 0;
if ($Employer_ESI > 0) {
    $Insurance = 0;
} else {
    if ($additional_insurance > 0) {
        $Insurance = 200 + $additional_insurance;
    } else {
        $Insurance = 200;
    }
}*/ 
...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <strong>Additional Insurance : </strong><?php echo number_format(round($additional_insurance), 2, '.', ','); ?>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
