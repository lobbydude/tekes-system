...
<h2 align='center' style='font-family:arial;'>Annexure 1.1</h2>
    <table border='1' style='border:1px solid #000'>
        ...
        <tr style='height:25px;font-family:arial;vertical-align:middle'>
            ...
            <td style='border:1px solid #000'><b>$Total_Fixed_Gross</b></td>
        ...
        <tr style='height:25px;font-family:arial;vertical-align:middle'>
            ...
            <td style='border:1px solid #000'><b>$employer_total</b></td>
        ...
        <tr style='height:25px;font-family:arial;vertical-align:middle'>
            ...
            <td style='border:1px solid #000'><b>$total_cost</b></td>
            <td style='border:1px solid #000'><b>$total_annual_cost</b></td>
        </tr>
        <tr style='height:25px;font-family:arial;vertical-align:middle'>
            <td>Employee PF</td>
            <td>$Employee_PF</td>
        ...
        <tr style='height:25px;font-family:arial;vertical-align:middle'>
            ...
            <td style='border:1px solid #000'><b>$Total_Deduction</b></td>
        ...
        <tr style='height:25px;font-family:arial;vertical-align:middle'>
            ...
            <td style='border:1px solid #000'><b>$Net_Salary</b></td>
