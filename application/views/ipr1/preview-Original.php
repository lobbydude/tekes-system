...
if ($count_payslip == 1) {
	...
	if($username=="0037" || $username=="0070" || $username=="0135" || $username=="0166" || $username=="0165" ){
		...
		if (($user_role == 1 && ($curr_date_calender > $set_calender_date)) || ($user_role == 3 && ($curr_date_calender > $set_calender_date)) || ($user_role == 4 && ($curr_date_calender > $set_calender_date)) || ($user_role == 5 && ($curr_date_calender > $set_calender_date)) || $user_role == 2 || $user_role == 6 || $user_role == 7) {
        ?>
        <div class="row">
            <div class="col-sm-12">
                ...
                <table class="table table-bordered">
                    <tbody>                                
                        <tr>
                            ...
                            <td><?php echo $No_Of_Days_Present; ?> Days</td>
						</tr>
                        <tr>
        ...
        <table class="table table-bordered datatable">
            ...
            <tbody>
                ...
                <tr>
                    <td>Arrears</td>
                    <td><p class="pull-right"><?php echo $Salary_Arrears; ?></p></td>
                    <td></td>
                    <td></td>                                                                          
                </tr>
                <tr>
