        ...
        if (($user_role == 1 && ($curr_date_calender > $set_calender_date)) || ($user_role == 3 && ($curr_date_calender > $set_calender_date)) || ($user_role == 4 && ($curr_date_calender > $set_calender_date)) || ($user_role == 7 && ($curr_date_calender > $set_calender_date)) || ($user_role == 5 && ($curr_date_calender > $set_calender_date)) || $user_role == 2 || $user_role == 6) {
            ...
            <form role="form" id="add_ipr_report_form" name="add_ipr_report_form" method="post" class="validate">
                ...
                <table class="table table-bordered">
                    ...
                    <input type="hidden" name="add_ipr_year" id="add_ipr_year" value="<?php echo $Year; ?>">
                    ...
                    <td><b class="btn btn-blue"><?php echo "$Final_Rating"; ?></b></td>                                                                        
                    </tr>
                    ...
                    <tr>
                        <td><b>Supervisor Date :</b> <br/><input name="add_ipr_supervisor_date" id="add_ipr_supervisor_date" type="text" size="27" placeholder="2017-09-06"></td>
                ...
                <div class="modal-footer" style="margin-top:-17px;">
                    <button type="submit" class="btn btn-primary" style="margin:0px 52% 0px 0px;">Submit</button>
                    <?php if($user_role == 1){ ?>
                    <button type="submit" class="btn btn-green" style="margin:-55px 40% 0px 64px; font-size: 13px;">Send to Employee</button>
                    <?php } ?>      
                    <?php if($user_role == 3){ ?>
                        <button type="submit" class="btn btn-green" style="margin:-55px 44% 0px 64px; font-size: 13px;">Accept</button>
                    <?php } ?>       
            ...
            <div class="row">
                <div class="col-md-12">                  
                    <span class="pull-left" style="margin:-4% -1% 0 1%;"> DRN/HR/IPR-Report</span> 
                    <span class="pull-right" style="margin:-4% 1% 0% 0%;">Ver 1.0</span>                                    
                </div>
            </div>
