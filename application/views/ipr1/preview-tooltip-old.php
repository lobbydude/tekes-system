...
<script src="<?php echo site_url('js/neon-custom.js') ?>"></script>
        ...
        <table class="table table-bordered datatable">
            ...
            <tbody>
                <tr>
                    <td>Efficiency</td>
                    <td align="center" class="btn btn-white" data-toggle="popover" data-trigger="hover" data-placement="top" 
                        data-content="Efficiency =>10% &nbsp;than => 1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Efficiency =>25% &nbsp;than => 1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Efficiency =>50% &nbsp;than => 2 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Efficiency =>65% &nbsp; than => 2.5 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Efficiency =>90% &nbsp;than => 3 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Efficiency =>100% &nbsp;than => 4 and 5"
                        data-original-title="Efficiency Calculation">2.5</td>
                ...
                <tr>
                    <td>Accuracy</td>
                    <td align="center" class="btn btn-white" data-toggle="popover" data-trigger="hover" data-placement="top" 
                        data-content="Accuracy =>90% &nbsp;than => 1 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Accuracy =>98% &nbsp;than => 3 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Accuracy =>100% &nbsp;than => 4 and 5"
                        data-original-title="Accuracy Calculation">4</td>
                ...
                <tr style="background-color:lightblue;">
                    ...
                    <td align="center" class="btn btn-white" data-toggle="popover" data-trigger="hover" data-placement="top" 
                        data-content="(Efficiency / 5) * 30 + &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (Accuracy / 5) * 30 + &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (Punctuality / 5) * 10 + &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (Processknowledge / 5) * 20 +  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (Teamwork / 5) * 10"
                        data-original-title="Overall Score Calculation"><b style="color: #fff; background-color: green;">80%</b></td>
