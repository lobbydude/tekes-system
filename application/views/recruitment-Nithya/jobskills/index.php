                            ...
                            <div class="row">                                
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="add_jobskills_name" id="add_jobskills_name" class="form-control" placeholder="Skills Name" data-validate="required" data-message-required="Please enter Skill name">
                                    </div>
                                </div>
                                <!--<div class="col-sm-4">
                                    <div class="form-group">
                                         <label class="col-sm-3 control-label">Tags Input12</label>                                    
