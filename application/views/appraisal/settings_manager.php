...
<script type="text/javascript">
    function manager_upload_appraisal(id) {
        $("#manager_appraisal_form_id").val(id);
    }
    $(function () {
    ...
    $(document).ready(function () {
        $('#manager_appraisalsettings_form').submit(function (e) {
         ...
         $("#manager_upload_appraisal_form").on('submit', (function (e) {
            e.preventDefault();
            $.ajax({
                url: "<?php echo site_url('appraisal/upload_manager_appraisalform') ?>",
                type: "POST",
...
<div class="main-content">
    <div class="container">
                    ...
                    <table class="table table-bordered datatable" id="appraisal_table">
                        <thead>
                            <tr>
                                ...
                                <th>Period</th> 
                                <th>Visible From (Manager)</th>
                                <th>Visible To (Manager)</th>
                                <th>Employee</th>
                                <th>Visible From (Employee)</th>
                                ...
                                foreach ($q_emp->result() as $row_emp) {
                                    ...
                                    if ($reporting_id == $username) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a data-toggle='modal' href='#manager_upload_appraisal' class="btn btn-default btn-sm btn-icon icon-left" onclick="manager_upload_appraisal(<?php echo $A_Id; ?>)">
        ...
        <div class="modal fade custom-width" id="manager_upload_appraisal">
            <div class="modal-dialog" style="width:60%">
                <div class="modal-content">
                    ...
                    <form role="form" id="manager_upload_appraisal_form" name="manager_upload_appraisal_form" method="post" class="validate" enctype="multipart/form-data" >
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                            ...
                            <input type="hidden" name="manager_appraisal_form_id" id="manager_appraisal_form_id" value="">
                            <div class="row" style="margin-bottom: 10px">                           
                                <div class="col-md-3">
                                    <label class="control-label">Upload Form</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="file" placeholder="Upload Form" data-validate="required" data-message-required="Please upload" name="userfile" id="userfile" class="form-control file2 inline btn btn-primary" accept="image/*" data-label="<i class='glyphicon glyphicon-file'></i> Browse"/>                                    
                                </div>
                            </div>                                                   
                        </div>
                        <div class="modal-footer">
