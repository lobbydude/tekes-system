...
if ($app_count_oct > 0) {
    foreach ($q_app_oct->result() as $row_app_oct) {
        $Visible_From_Manager_oct = $row_app_oct->Visible_From_Manager;
        $Visible_To_Manager_oct = $row_app_oct->Visible_To_Manager;
    }
    $current_date_oct = date('Y-m-d');
    if ($Visible_From_Manager_oct <= $current_date_oct || $current_date_oct >= $Visible_To_Manager_oct) {
        ?>
                        ...
                        <div class="row">
                            <div class="panel-heading info-bar" >
                                <div class="panel-title">
                                    <h2>Employees - October Month Cycle</h2>
                                </div>
                            </div>
