                        ...
                        <?php if ($user_role == 2 || $user_role == 6) { ?>
                            ...
                            ?>">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="<?php echo site_url('Allowance'); ?>">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="<?php echo site_url('Leaves/Leavecompoff'); ?>">
                                    ...
                                    <li>
                                        <a href="<?php echo site_url('Recruitment'); ?>">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a href="<?php echo site_url('Jobskills');  ?>">
                                                    <span class="title">Job Skills</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="<?php echo site_url('Recruitment/Jobpost');  ?>">
                                                    <span class="title">Job Post Requisitions</span>
                                                </a>
                                            </li>
                                            <li>
                                ...
                                <ul>
                                    ...
                                    if ($count_career > 0) {
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="<?php echo site_url('Leaves/CCompOff') ?>">
                                                        Comp Off
                                                    </a>
                                                </li>
                                                <li>
