...
<h2> <?php echo date('F', mktime(0, 0, 0, $month, 10)); ?> month Attendance timings </h2>
<table class="table table-bordered" id="data_displacement">
                    <thead> 
                        <tr>
                    ...
                    <tbody>
                        ...
                        if ($user_role == 2 || $user_role == 6) {
                            ...
                            //$num_rows_emp = $this->db->get('tbl_employee')->num_rows();
                            //print_r($num_rows_emp);die;

                            //$num_emp[] = round($num_rows_emp / 2 );
                            //$num_emp[] = $num_rows_emp;
                            


                            //print_r($num_emp);die;
                           // $limiting = 0;
                           // foreach ($num_emp as $key => $limit_data) {

                                //print_r($limit_data);die;

                           $cur_from = $cur_from == 1 ? 0: $cur_from;
                                
                                $this->db->where($data_download);
                                $this->db->order_by('Employee_Id', 'ASC');
                                $this->db->limit(($cur_to-$cur_from),$cur_from);
