				...
				<!--<th>Login User</th>-->
                                                ...
                                                <ul class="nav navbar-right pull-right">
                                                    ...
                                                    if ($count_shift_all != "") {
                                                        ...
                                                        if (strtotime($shift_24_hour_format) > strtotime($Login_Time)) {
                                                            ...
                                                            //$total_early1 = $total_early_Login_hours +$total_early_Login_mintes;
                                                        }
                                                    }
                                                    ?>                                        
                                                    <?php
                                                    ...
                                                    if ($count_shift_all != "") {
                                                        if (strtotime($shift_24_hour_format) < strtotime($Login_Time)) {
                                                            ...
                                                            $total_Late = $total_early_Login_hours + $total_early_Login_mintes;
                        ...
                        <tbody>                            
                            ...
                            <tr>
                                ...
                                <td><?php echo "<span style='color:blue'>$total_early_Login_hours H : $total_early_Login_mintes M</span>";?> </td>
                                <td><?php echo "<span style='color:blue'>$total_late_Login_hours H : $total_late_Login_mintes M</span>";?> </td>
                            </tr>
                        </tbody>
