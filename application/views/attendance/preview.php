...
<script>
    $(document).ready(function () {
        $("#timesheet_download_button1").click(function () { // button Id
            $("#atten_table1").btechco_excelexport({// Table Id
                containerid: "atten_table1", // Table Id
                datatype: $datatype.Table
            });
        });
    });
...
<div class="container">        
    <section class="topspace blackshadow bg-white">    
        <div class="col-md-12">
            <a class="btn btn-primary" style="margin-left:90.25%; margin-top:-152px;" id="timesheet_download_button1">
                Download
        ...
        <div class="col-md-12">
            <div class="row">          
                ...
                <table class="table table-bordered datatable" id="atten_table">
                    <thead>
                        <tr>
                            <?php if ($user_role == 2 || $user_role == 6 || $user_role == 1 || $user_role == 7) { ?>
                    ...
                    <tbody>
                        ...
                        if ($user_role == 2 || $user_role == 6 || $user_role == 1 || $user_role == 7) {
                            ...
                            if ($count_in > 0) {
                                $i = 1;
                                $total_early_Login_mintes = "0";
                                $total_early_Login_hours = "0";
                                $total_late_Login_mintes = "0";
                                $total_late_Login_hours = "0";
                                $Latelogin_count = 0;
                                $totallateCount = 0;
                                foreach ($q_in->Result() as $row_in) {
                                    ...
                                    ?>>
                                        ...
                                        <td><?php echo "$Latelogin_count"; ?></td>
                                        <?php if ($user_role == 1 || $user_role == 6) { ?>
                                        <td>
                                    ...
                                    if ($count_shift_all != "") {
                                        ...
                                        if (strtotime($shift_24_hour_format) > strtotime($Login_Time)) {
                                            ...
                                            //echo "<span style='color:#006400;'>$before_hours H : $before_minutes M : $before_second S</span>";                                                                                                                                                           
                                            ...
                                            $total_early = $total_early_Login_hours + $total_early_Login_mintes;
                                        }
                                    }
                                    ?>                                        
                                    <?php
                                    ...
                                    if ($count_shift_all != "") {
                                        if (strtotime($shift_24_hour_format) < strtotime($Login_Time)) {
                                            ...
                                            $late_minutes = $late_total_mins % 60;
                                            $late_second = 0;
                                            //echo "<span style='color:red'>$late_hours H : $late_minutes M : $late_second S</span>";                                                    
                                            $total_late_Login_mintes = $late_minutes + $total_late_Login_mintes;
                                            $total_late_Login_hours = $late_hours + $total_late_Login_hours;
                                            $total_latehours = $total_late_Login_hours + $total_late_Login_mintes;
                                        }
                                    }
                                    ?>
                    ...
                    <tbody>                                                        
                        <tr>
                            ...
                            <td></td>												
                            <td><?php echo "<a href='#' style='color:red'>$totallateCount Days Late Login</a>"; ?> </td>
                        </tr>
                    </tbody>                       
                </table>                    
        ...
        <!-- Download Table Content Start Here-->
        <div id="dv">
            <div id="atten_table" class="atten_table" style="display:none;">
                <div class="col-md-12">
                    <div class="row">          
                        <!-- Attendance Table Format Start Here -->  

                        <table class="table table-bordered datatable" id="atten_table1">
                            <thead>
                                <tr>
                                    <?php if ($user_role == 2 || $user_role == 6 || $user_role == 1 || $user_role == 7) { ?>
                                        <th style="width:1%;">S.No</th>
