...
<script>
    function instruction_print(divName) {
                    ...
                    <div class="form-wizard">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="birthdate" id="birthdate" class="form-control datepicker" data-format="dd-mm-yyyy" data-validate="required" data-start-view="2" data-message-required="Please enter date of birth.">
                                                    <div class="input-group-addon">
                                                        <a href="#"><i class="entypo-calendar"></i></a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="actual_birthdate" id="actual_birthdate" class="form-control datepicker" data-format="dd-mm-yyyy" data-start-view="2">
                                                    <div class="input-group-addon">
                                                        <a href="#"><i class="entypo-calendar"></i></a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="control-label" for="birthdate">Date of Birth</label>
                                                <div class="input-group">
                                                    <input type="text" name="personal_birthdate" id="personal_birthdate" class="form-control datepicker" data-format="dd-mm-yyyy" data-validate="required" data-start-view="2" data-message-required="Please select birth date.">
                                                    <div class="input-group-addon">
                                                        <a href="#"><i class="entypo-calendar"></i></a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="control-label" for="birthdate">Actual Date of Birth</label>
                                                <div class="input-group">
                                                    <input type="text" name="personal_actual_birthdate" id="personal_actual_birthdate" class="form-control datepicker" data-format="dd-mm-yyyy" data-start-view="2" data-message-required="Please select birth date.">
                                                    <div class="input-group-addon">
                                                        <a href="#"><i class="entypo-calendar"></i></a>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="family_member_dob" id="family_member_dob" class="form-control datepicker" data-format="dd-mm-yyyy" onchange="getAge(this.value)" data-validate="required" data-start-view="2" data-message-required="Please enter date of birth.">
                                                    <div class="input-group-addon">
                                                        <a href="#"><i class="entypo-calendar"></i></a>
                                                    </div>
                                                </div>
                            ...
                            <div class="tab-pane" id="tab9">                               
                                <div id="instruction_print">
                                    <!--<h2 style="text-align:center">Welcome to DRN Definite Solutions Pvt Ltd.,</h2>-->
                                    <h3 style="text-align:center;"> Welcome to DRN Definite Solutions Pvt Ltd.,</h3>                                    
                                    <p align="justify">DRN Definite Solutions is a global business process Outsourcing Company. We are primarily engaged in providing Mortgage and Technology services, Enterprise application development, Application software for the Financial Services industry and Business process outsourcing. Leading business companies are looking to Streamline and Simplify their operations.</p>
                                    <p align="justify">We provide a wide variety of services including Back Office, Research, Finance and Accounting, Contact Center, IT Outsourcing, Healthcare and Logistics Services. We serve a number of industries, where we have developed deep domain expertise including: Technology, Healthcare, Social Media, Research, Financial Services and Services Industries. </p>
                                    <p align="justify">Our solutions enable companies to substantially reduce costs to improve margins and conserve cash. We help businesses become more scalable, ramp more efficiently, and get to market faster.</p>
                                    <h4>Our Mission</h4>
                                    ...
                                    <div class="row">
                                        <div class='col-md-12'>
                                            Your details has been registered successfully. You can use the following login credentials.<br/>
                                            <b>Login URL :</b> http://192.168.12.151:82/TEKES/Login                                            
                                            <div class="form-group" id='login_details'>
                                            </div>
                                        </div>
                                        <div class='col-md-12'>
                                            <img src="http://192.168.12.151:82/TEKES/images/empp.png" height="370">                                        
                                        </div>
                                    </div>					 
                                </div>                           
                                <div id="editor"></div>
                                <div class="row">
                                    <div class="col-md-3">	
                                        <div class="form-group">
                                            ...
                                            <a href="#" class="btn btn-primary" onclick="instruction_print('instruction_print')"><i class="entypo-print"></i>Print</a>
                                        </div>
                                    </div>
                                </div>
