<?php
// tbl_ employee table Name only get start
$this->db->order_by('Employee_Id', 'desc');
$this->db->limit(1);
$q_empname = $this->db->get('tbl_employee');
foreach ($q_empname->result() as $row_empname) {
...
// tbl_ employee table Name only get End
// tbl_user table UserName Password only get start
$this->db->order_by('User_id', 'desc');
$this->db->limit(1);
$q_empdetail = $this->db->get('tbl_user');
foreach ($q_empdetail->result() as $row_empdetail) {
    $emp_username = $row_empdetail->Username;
    $emp_password = $row_empdetail->Password;    
    //$start_number = $row_empcode->employee_number;
    //$emp_id = str_pad(($start_number + 1), 4, '0', STR_PAD_LEFT);
}
// tbl_user table UserName Password only get End
...
<script>
    $(document).ready(function () {
        ...
        $('#background_button').click(function (e) {
            ...
            var background_verification;
            if (document.getElementById("background_verification_yes").checked) {
                background_verification = document.getElementById("background_verification_yes").value;
            } else {
                background_verification = document.getElementById("background_verification_no").value;
            }
                                        ...
                                        <tbody>
                                            ...
                                            if ($count_document > 0) {
                                                foreach ($select_document->result() as $row_document) {
                                                    ...
                                                    $file_url = "http://localhost/TEKESLIVE/upload/";
                                                    ?>
                                                    <tr>
                            ...
                            <div class="tab-pane" id="tab9">                               
                                <div id="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class='col-md-12'>
                                            <img src="http://localhost/TEKESLIVE/images/empprocess1.png">
                                        </div>
                                    </div>                                    
                                </div>                           
                                
                                <div id="instruction_print" style="display:none;">                                
                                    <h3 style="text-align:center"> <?php echo "$emp_firstname $emp_lastname $emp_middlename ";?>&nbsp;&nbsp;&nbsp; Welcome to DRN Definite Solutions Pvt Ltd.,</h3>
                                    ...
                                    <div class="row">
                                        <div class='col-md-12'>
                                            Your details has been registered successfully. You can use the following login credentials.
                                            <b>Login URL</b> : http://192.168.12.151:82/TEKES/Login
                                            <h4><b>Username</b> : <?php echo "$emp_username &nbsp;&nbsp; <b>Password</b>: $emp_password ";?></h4>
                                        </div>                                                                             
                                        <div class='col-md-12'>
                                            <img src="http://localhost/TEKESLIVE/images/empprocess1.png">
                                        </div>
