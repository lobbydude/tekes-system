...
class Employee extends CI_Controller {
    ...
    public function Index() {
        ...
        if ($user_role == 1 ||  $user_role == 2 || $user_role == 6 || $user_role == 4 || $user_role == 5) {
            $data = array(
                'title' => 'Employee',
        ...
        if (is_array($_FILES)) {
            if (is_uploaded_file($_FILES['attach_file']['tmp_name'])) {
                ...
                if (move_uploaded_file($sourcePath, $targetPath)) {
                    ...
                    $file_url = "http://localhost:82/TEKESLIVE20161/upload/";
...
//        }
    ...
    function background_verification() {
        ...
        if ($q) {
            ...
            echo "<strong>Username: </strong>$username<br><strong>Password: </strong>$new_password";
        }
    }
    ...
    public function Editemployee() {
        ...
        } if ($user_role == 2 || $user_role == 1 || $user_role == 6 || $user_role == 4 || $user_role == 5) {
