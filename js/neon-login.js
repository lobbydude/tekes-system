        ...
        neonLogin.$container.validate({
            ...
            submitHandler: function (ev)
            {
                ...
                setTimeout(function ()
                {
                    ...
                    $.ajax({
                        url: 'http://192.168.12.151:82/TEKES/Login/validate',
                        type: 'post',
                        data: {
                        ...
                        success: function (response)
                        {
                            ...
                            setTimeout(function ()
                            {
                                ...
                                if (response == '1')
                                {
                                    ...
                                    $('#manager_popup').modal('show', {backdrop: 'static'});

                                }
                                 if (response == '2')
                                {
                                    // Redirect to login page
                                    $('#hr_popup').modal('show', {backdrop: 'static'});

                                }
                                if (response == '3') {
                                    setTimeout(function ()
                                    {
                                        var redirect_url = "http://192.168.12.151:82/TEKES/Profile";
                                ...
                                {
                                    // Redirect to login page
                                    $('#admin_popup').modal('show', {backdrop: 'static'});

                                }
								if (response == '7')
                                {
                                    // Redirect to login page
                                    $('#supervisor_popup').modal('show', {backdrop: 'static'});
                                ...
                                {
                                    // Redirect to login page
                                    $('#it_popup').modal('show', {backdrop: 'static'});
                                ...
                                {
                                    // Redirect to login page
                                    $('#superadmin_popup').modal('show', {backdrop: 'static'});
                                }
